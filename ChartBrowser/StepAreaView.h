...
// CStepAreaView form view

class CStepAreaView : public CBaseView
{
	DECLARE_DYNCREATE(CStepAreaView)

protected:
	CStepAreaView();           // protected constructor used by dynamic creation
	virtual ~CStepAreaView();
