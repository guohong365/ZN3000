...
enum IDITEM
{
	...
	ID_ITEM_RANGEAREASTYLE,
	ID_ITEM_STEPAREASTYLE,
...
void CExplorerBar::Create(CWnd* pWndParent)
{
	...
	AddLinkItem(pGroup, ID_ITEM_RANGEAREASTYLE, _T("Range Area"));
	AddLinkItem(pGroup, ID_ITEM_STEPAREASTYLE, _T("Step Area"));
	...
	AddLinkItem(pGroup, ID_ITEM_VIRTUALPOINTS, _T("Virtual Points"));
...
void CExplorerBar::OnItemClick(UINT nID)
{
	...
	case ID_ITEM_AREASTYLE:
		...
		break;
	case ID_ITEM_RANGEAREASTYLE:
		pMainFrame->SetView(RUNTIME_CLASS(CRangeAreaView));
		break;
	case ID_ITEM_STEPAREASTYLE:
		pMainFrame->SetView(RUNTIME_CLASS(CStepAreaView));
		break;
	...
	case ID_ITEM_DATETIME:
		...
		break;	
	case ID_ITEM_VIRTUALPOINTS:
		pMainFrame->SetView(RUNTIME_CLASS(CVirtualPointsView));
		break;	
	}
}
