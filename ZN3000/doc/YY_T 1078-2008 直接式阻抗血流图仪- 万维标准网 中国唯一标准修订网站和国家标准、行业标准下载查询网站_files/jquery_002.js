...
$._dialog = {
	...
	build : function(options){
		...
		if (!dialog){
			...
			if(options.title.indexOf("评论")>-1){
				var html='<div class="dialog" id="dialog_'+id+'" style="position:absolute;left:-10000px;top:-10000px; z-index:2010; "><table  class="dialog" align="center" style="border:none;height:100%;width:100%;"><tr><td name="content" valign="top" align="center" style="color:#FFFFFF; font-size:15px; font-weight:bold;height:38px; background-image:url(style/default/tishibg.gif); background-repeat:no-repeat; background-position:center;"></td></tr></table></div>';
			}else{			
